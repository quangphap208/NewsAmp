...
class ArticleViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    var sideMenu = SideMenuViewController.instantiateFromStoryboardArticles(UIStoryboard(name: "Main", bundle: nil))
    ...
    func setButtonsImages() {
        ...
        self.menuButton.addTarget(self, action: #selector(TopArticlesViewController.showMenu(_:)), for: UIControlEvents.touchUpInside)
        ...
        self.searchButton.addTarget(self, action: #selector(TopArticlesViewController.searchButtonAction(_:)), for: UIControlEvents.touchUpInside)
        ...
        self.gridDisplayButton.addTarget(self, action: #selector(TopArticlesViewController.gridDisplay(_:)), for: UIControlEvents.touchUpInside)
    ...
    func noData(message: String) {
        ...
        noResultsLabel.font = UIFont(name: "Roboto-Light" , size: 12)
    ...
    func listDisplay(cell: collectionCell) {
        ...
        cell.sourceName = UILabel(frame: CGRect(x: 40, y: 100, width: 230, height: 15))
        cell.sourceName.textColor = UIColor.white
        cell.sourceName.font =  UIFont(name: "Roboto-Light" , size: 12)
        cell.sourceName.text = "Source Name"
        cell.sourceImage = UIImageView(frame: CGRect(x: 10, y: 95, width: 25, height: 25))
        cell.sourceImage.layer.masksToBounds = false
        cell.sourceImage.layer.cornerRadius = 2.0
        cell.backgroundViewCell.addSubview(cell.sourceImage)
        cell.backgroundViewCell.addSubview(cell.sourceName)
        ...
        cell.titleLabel.font = UIFont(name: "Roboto-Bold" , size: 20)
        ...
        cell.descriptionLabel.font = UIFont(name: "Roboto-Light" , size: 16)
    ...
    func gridDisplay(cell: collectionCell) {
        ...
        cell.sourceName = UILabel(frame: CGRect(x: 40, y: 15, width: 115/2 - 20, height: 15))
        cell.sourceName.textColor = UIColor.white
        cell.sourceName.font =  UIFont(name: "Roboto-Light" , size: 12)
        cell.sourceName.text = "Source Name"
        
        cell.sourceImage = UIImageView(frame: CGRect(x: 5, y: 10, width: 25 , height: 25))
        cell.sourceImage.layer.masksToBounds = false
        cell.sourceImage.layer.cornerRadius = 2.0
