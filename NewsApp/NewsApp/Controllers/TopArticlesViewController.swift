...
//  NewsApp
//
//  Created by Alina Costache on 11/1/16.
...
class TopArticlesViewController: ArticleViewController, UISearchBarDelegate, UIGestureRecognizerDelegate, delegateArticles {
    ...
    //This array containes all the categories.
    ...
    func setGestureRecognizers() {
        self.gestureLeft = UIScreenEdgePanGestureRecognizer(target: self, action: #selector(TopArticlesViewController.handleTap(_:)))
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.addToArticlesList.addTarget(self, action: #selector(TopArticlesViewController.markUnmarkArticle(_:)), for: UIControlEvents.touchUpInside)
    ...
    func markUnmarkArticle(_ sender: UIButton) {
        ...
        if sender.accessibilityLabel == "topArticles" {
            articleToSave = Article(source: self.topArticles[row].source,
                                    category: self.topArticles[row].category,
                                    sourceImage: self.topArticles[row].sourceImage,
